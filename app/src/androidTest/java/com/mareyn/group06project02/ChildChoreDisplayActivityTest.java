 ...
 * ChildChoreDisplayActivity. It ensures the correct screen navigation
 * flow between the landing page and ChildChoreDisplayActivity.</p>
 */

public class ChildChoreDisplayActivityTest {
  ...
  @Test
  public void clickToChoreDisplay_startChildChoreDisplay() {
    ...
    User admin2 = new User(1, "testuser1", "testuser1", "", false);
